<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="sidebar-wrap">
                        <div class="siderbar-widget">
                            ...
                            <div class="search-form">
                                <form action="<?php echo home_url('/'); ?>" method="get">
                                    <input class="search-field" placeholder="Search" value="<?php echo $s ?>" name="s" type="search"><!-- echo _e(''); echo '&quot;'. $s .'&quot;'; -->
                        ...
                        <div class="siderbar-widget">
                            ...
                            <?php
                                ...
                                foreach($categories as $categories){
                                    echo '<li><a href="'. get_category_link($categories->term_id).'">'. $categories->name.'</a></li>';
                        ...
                        <div class="siderbar-widget">
                            ...
                            <ul>
                                <?php wp_get_archives(array('type' => 'monthly', 'Limite'=>12, 'order'=>'asc'));?>
